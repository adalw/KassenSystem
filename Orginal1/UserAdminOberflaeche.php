<html>
    ...
    <body>
		...
		<form action="UserAdminOberflaeche.php" method="GET">  
...
<!--       Bestellung       -->	
	...
	<form action="atestUserAdminOberflaeche.php" method="Post">
...
// select DB
	...
	echo "<form action=atestUserAdminOberflaeche.php method=post>";
	echo "<tr>";
